...
$_lang['sendex_newsletters_remove'] = 'Удалить Подписку';
$_lang['sendex_newsletters_remove_confirm'] = 'Вы уверены, что хотите удалить эти Подписки?';
$_lang['sendex_newsletter_remove_confirm'] = 'Вы уверены, что хотите удалить этот Подписку?';
